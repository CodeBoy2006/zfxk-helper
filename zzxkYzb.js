...
jQuery(function($){
	var text_wdgwc = $("#xxdm").val()=="10564" ? $.i18n.get("msg_wdxkyx") : $.i18n.get("msg_wdgwc");
	if($("#xkxfqzfs").val()!="1"){
		$(".l-kc-xf").show();
	}
	if($("#xkgwckg").val()=="1"){
		if($("#but_ancd").length>0){
			if($("#btn_jf").length>0){
				$("#btn_jf").before("<button type='button' class='btn btn-default btn_gwc' href='javascript:void(0);' id='btn_gwc'><i class='bigger-100 glyphicon glyphicon-shopping-cart'></i> "+text_wdgwc+"</button>");
			}else{
				$("#but_ancd").append("<button type='button' class='btn btn-default btn_gwc' href='javascript:void(0);' id='btn_gwc'><i class='bigger-100 glyphicon glyphicon-shopping-cart'></i> "+text_wdgwc+"</button>");
			}
		}else{
			var _html = [];
			_html.push("<div class='btn-toolbar' role='toolbar' style='float: right; z-index: 1050;'>");
			_html.push("<div class='btn-group' id='but_ancd'>");
			_html.push("<button type='button' class='btn btn-default btn_gwc' href='javascript:void(0);' id='btn_gwc'><i class='bigger-100 glyphicon glyphicon-shopping-cart'></i> "+text_wdgwc+"</button>");
			_html.push("</div>");
			_html.push("</div>");
	...
	jQuery("#xkkz_xh").val(jQuery("#firstXkkzXh").val());
	...
	jQuery("#searchBox").searchBox({
		...
		afterRender:function(){
			...
			if($(".condition-item").find(".condition-row").length>5){
				if($(".condition-retract").find(".up").length>0){
					$(".condition-retract").find(".up").click();
				}
			}
...
function loadJxbxxZzxk(obj){
	...
	if(czzt=="0"){
		...
		$.extend(requestMap,{
			...
			"sfznkx":$("#sfznkx").val(),"zdkxms":$("#zdkxms").val(),"sfkxq":$("#sfkxq").val(),"bhbcyxkjxb":$("#bhbcyxkjxb").val(),"sfkcfx":$("#sfkcfx").val(),"bbhzxjxb":$("#bbhzxjxb").val(),
			"kkbk":$("#kkbk").val(),"kkbkdj":$("#kkbkdj").val(),"bklbkcj":$("#bklbkcj").val(),"xkxnm":$("#xkxnm").val(),"xkxqm":$("#xkxqm").val(),"xkxskcgskg":$("#xkxskcgskg").val(),
			/*"njdm_id_xs":$("#njdm_id_xs").val(),"zyh_id_xs":$("#zyh_id_xs").val(),*/"rlkz":$("#rlkz").val(),"cdrlkz":$("#cdrlkz").val(),"cxcykclxxskg":$("#cxcykclxxskg").val(),
			"rlzlkz":$("#rlzlkz").val(),"kklxdm":$("#kklxdm").val(),"kch_id":$(obj).find("input[name='kch_id']").val(),"jxbzcxskg":$("#jxbzcxskg").val(),"zxgbxkkg":$("#zxgbxkkg").val(),
			...
			setTimeout(function(){
				if(data!=null){
					...
					for(var i=0; i<data.length; i++){
						...
						if($("#xxdm").val()=="10564"){
							trObj.find(".ktmc").html($.founded(data[i].ktmc) ? data[i].ktmc : data[i].jxbzc);
						}
						if($("#sfxsjxdd").val()=="1"){
						...
						if($("#cxcykclxxskg").val()=="1"){
							trObj.find(".cxcykclx").text(data[i].cxcykclx);
						}
					...
					$(obj).parent().find("div table tbody").find(".jxb_id").each(function(index,item){
						...
						if($("#jzxkf").val()=="0" && $("#isinxksj").val()!="1" && $("#xkgwckg").val()=="1"){
							var text_jrgwc = $("#xxdm").val()=="10564" ? $.i18n.get("msg_yixxk") : $.i18n.get("msg_jrgwc");
							trObj.find("td.an").html("<button id='btn-xk-"+m_jxb_id+"' type='button' class='btn btn-primary btn-sm' onclick=insertGwcZzxk('"+m_jxb_id+"','"+m_do_jxb_id+"','"+kch_id+"','"+m_jxbzls+"')>"+text_jrgwc+"</button>");
    ...
    if(isEnd=="true"){
		...
		if(parseInt(jspage)==step && $("#js_kcrow").val()*1 < step*1){//未瀑布加载前已到最后页时，就不需要再次访问数据库
			...
			$.extend(requestMap,{
				...
				"sfkkzy":$("#sfkkzy").val(),"kzybkxy":$("#kzybkxy").val(),"sfznkx":$("#sfznkx").val(),"zdkxms":$("#zdkxms").val(),"sfkxq":$("#sfkxq").val(),"bhbcyxkjxb":$("#bhbcyxkjxb").val(),
				/*"njdm_id_xs":$("#njdm_id_xs").val(),"zyh_id_xs":$("#zyh_id_xs").val(),*/"sfkcfx":$("#sfkcfx").val(),"kkbk":$("#kkbk").val(),
				"kkbkdj":$("#kkbkdj").val(),"bklbkcj":$("#bklbkcj").val(),"sfkgbcx":$("#sfkgbcx").val(),"sfrxtgkcxd":$("#sfrxtgkcxd").val(),"xkkz_xh":$("#xkkz_xh").val(),
				"tykczgxdcs":$("#tykczgxdcs").val(),"xkxnm":$("#xkxnm").val(),"xkxqm":$("#xkxqm").val(),"kklxdm":$("#kklxdm").val(),"bbhzxjxb":$("#bbhzxjxb").val(),"zxgbxkkg":$("#zxgbxkkg").val(),
				...
				if(data!=null && data.length>0){
					...
					for(var i=0; i<data.length; i++){
						...
						if(l_kchid != mdA.kch_id){
							...
							if ($("#xxdm").val() == "10564") {
								s_html.push("("+mdA.kch+")<span>"+mdA.kcmc+"</span>");
							} else {
							...
							if($("#zzxkxskg_kctd").val()=="1"){
								s_html.push("<span id='thkc_txt_"+mdA.kch_id+"'>"+"替代课程:"+(mdA.thkcmc?mdA.thkcmc:'无')+"</span>");
							}
							s_html.push("</h3>");
						...
						if(l_jxbid != mdA.jxb_id){
							...
							if(mdA.kch_id!=h_kchid){
								...
								if($("#xxdm").val()=="10564"){
									s_html.push("<th nowrap>"+$.i18n.get("msg_ktmc")+"</th>");//课堂名称
								}
								if($("#sfxsjxdd").val()=="1"){
								...
								if($("#cxcykclxxskg").val()=="1"){
									s_html.push("<th>"+$.i18n.jwglxt["cxcykclx"]+"</th>");//创新创业课程类型
								}
							...
							if($("#xxdm").val()=="10564"){
								s_html.push("<td class='ktmc' nowrap></td>");
							}
							if($("#sfxsjxdd").val()=="1"){
							...
							if($("#cxcykclxxskg").val()=="1"){
								s_html.push("<td class='cxcykclx'></td>");
							}
							if($("#zzxkgjcxkg_kcxz").val()=="1"){
					...
					if($("#xkkczdsqkg").val()=="2"){
						$("input[name='czzt']").each(function(index,item){
							if($(item).val()=="0"){
								$(item).parent().click();
							}
						});
